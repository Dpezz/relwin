...
class TerminalsControllerTest < ActionController::TestCase
  ...
  test "should create terminal" do
    assert_difference('Terminal.count') do
      post :create, terminal: { description: @terminal.description, name: @terminal.name, user_id: @terminal.user_id }
    end
  ...
  test "should update terminal" do
    patch :update, id: @terminal, terminal: { description: @terminal.description, name: @terminal.name, user_id: @terminal.user_id }
    assert_redirected_to terminal_path(assigns(:terminal))
  end
