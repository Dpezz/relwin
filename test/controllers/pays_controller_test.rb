...
class PaysControllerTest < ActionController::TestCase
  ...
  test "should create pay" do
    assert_difference('Pay.count') do
      post :create, pay: { code: @pay.code, method: @pay.method, sale_id: @pay.sale_id, terminal_id: @pay.terminal_id }
    end
  ...
  test "should update pay" do
    patch :update, id: @pay, pay: { code: @pay.code, method: @pay.method, sale_id: @pay.sale_id, terminal_id: @pay.terminal_id }
    assert_redirected_to pay_path(assigns(:pay))
  end
