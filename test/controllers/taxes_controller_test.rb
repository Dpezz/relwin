...
class TaxesControllerTest < ActionController::TestCase
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post :create, tax: { cantidad: @tax.cantidad, description: @tax.description, name: @tax.name, product_id: @tax.product_id }
    end
  ...
  test "should update tax" do
    patch :update, id: @tax, tax: { cantidad: @tax.cantidad, description: @tax.description, name: @tax.name, product_id: @tax.product_id }
    assert_redirected_to tax_path(assigns(:tax))
  end
