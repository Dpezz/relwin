...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { description: @measure.description, name: @measure.name, symbol: @measure.symbol }
    end
  ...
  test "should update measure" do
    patch :update, id: @measure, measure: { description: @measure.description, name: @measure.name, symbol: @measure.symbol }
    assert_redirected_to measure_path(assigns(:measure))
  end
