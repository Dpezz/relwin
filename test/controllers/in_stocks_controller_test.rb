...
class InStocksControllerTest < ActionController::TestCase
  ...
  test "should create in_stock" do
    assert_difference('InStock.count') do
      post :create, in_stock: { product_id: @in_stock.product_id, stock_id: @in_stock.stock_id, unit: @in_stock.unit }
    end
  ...
  test "should update in_stock" do
    patch :update, id: @in_stock, in_stock: { product_id: @in_stock.product_id, stock_id: @in_stock.stock_id, unit: @in_stock.unit }
    assert_redirected_to in_stock_path(assigns(:in_stock))
  end
