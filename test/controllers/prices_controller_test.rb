...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { costo: @price.costo, iva: @price.iva, margen: @price.margen, product_id: @price.product_id, venta: @price.venta }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { costo: @price.costo, iva: @price.iva, margen: @price.margen, product_id: @price.product_id, venta: @price.venta }
    assert_redirected_to price_path(assigns(:price))
  end
